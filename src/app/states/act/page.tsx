...
export const metadata: Metadata = {
  title: `ACT Licensing Guide | ${SITE.course.code} Requirements & Application`,
  description: `Complete guide to obtaining licensing in ACT for ${SITE.course.name}.`
};
...
export default function ACTPage() {
  const requirements = [
    ...
    "Meet Access Canberra requirements"
  ];
    ...
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground">
          Everything you need to know about obtaining licensing in the ACT for {SITE.course.name}
        </p>
      </div>
      ...
      <div className="mb-8 p-4 bg-primary/10 border border-primary/20 rounded-lg flex items-start gap-3">
        ...
        <p className="text-sm">
          <strong>Regulated by Access Canberra</strong>
        </p>
      </div>
