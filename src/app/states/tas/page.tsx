...
export const metadata: Metadata = {
  title: `TAS Licensing Guide | ${SITE.course.code} Requirements & Application`,
  description: `Complete guide to obtaining licensing in Tasmania for ${SITE.course.name}.`
};
    ...
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      <div className="mb-8">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">
          Tasmania Licensing Guide
        </h1>
        <p className="text-lg text-muted-foreground">
          Everything you need to know about obtaining licensing in Tasmania for {SITE.course.name}
        </p>
      </div>
      ...
      <div className="mb-8 p-4 bg-primary/10 border border-primary/20 rounded-lg flex items-start gap-3">
        ...
        <p className="text-sm">
          <strong>Regulated by Consumer, Building & Occupational Services</strong>
        </p>
      </div>
