            ...
            <div className="container px-4 md:px-6 mx-auto max-w-6xl relative">
                <div className="flex flex-col items-center justify-center space-y-10 text-center mb-28">
                    ...
                    <h2 className="text-5xl md:text-8xl font-black tracking-tighter text-slate-900 italic leading-[0.9]">
                        Regulatory <br />
                        <span className="text-primary not-italic">Knowledge Base</span>
                    </h2>
                                ...
                                <div key={category} className="space-y-10">
                                    ...
                                    <Accordion type="single" collapsible className="w-full space-y-6">
                                        {categoryItems.map((item, index) => (
                                            ...
                                            >
                                                <AccordionTrigger className="text-left text-xl font-black text-slate-900 hover:no-underline hover:text-primary transition-all py-8 tracking-tight uppercase leading-tight group-data-[state=open]:text-primary">
                                                    {item.question}
                                                </AccordionTrigger>
